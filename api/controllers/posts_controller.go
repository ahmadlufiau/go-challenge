...
import (
	...
	"github.com/ahmadlufiau/go-challenge/api/auth"
	"github.com/ahmadlufiau/go-challenge/api/models"
	"github.com/ahmadlufiau/go-challenge/api/responses"
	"github.com/ahmadlufiau/go-challenge/api/utils/formaterror"
...
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	responses.JSON(w, http.StatusNoContent, "Delete Success")
}
